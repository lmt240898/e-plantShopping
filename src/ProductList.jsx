...
function ProductList({ onHomeClick }) {
    const cartItems = useSelector((state) => state.cart.items); // cart từ slice `cart`
    ...
    const totalItems = cartItems.reduce((total, item) => total + item.quantity, 0); // Calculate the total number of items in the cart
